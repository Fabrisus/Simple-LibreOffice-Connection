...
*/
  ...
  */
  ...
  {  return loadOffice(false);  }    // default is to using office via socket. Pipes has bugs atm. https://bugs.documentfoundation.org/show_bug.cgi?id=149069
  ...
  */
  ...
  // https://forum.openoffice.org/en/forum/viewtopic.php?f=44&t=1014
  {
    ...
    try {
      ...
      cmdArray[0] = "C:\\Program Files\\LibreOffice\\program\\soffice.exe"; 
                // requires soffice to be in Windows PATH env var.
      cmdArray[1] = "--nologo"; // -headless
      cmdArray[2] = "-n";
      cmdArray[3] = "--nodefault";
      cmdArray[4] = "--norestore";
      cmdArray[5] = "-accept=socket,host=localhost,port=" +
                                               SOCKET_PORT + ";urp;";
